...
<body>
	<center>
		<h3>INSTITUTO FEDERAL DE EDUCAÇÃO, CIÊNCIA E TECNOLOGIA DE MATO GROSSO DO SUL</h3>
	</center>
...
<ul>
		<li>
	<?php echo $this->Html->link("GERENCIAR PLANOS DE ENSINO", "/Planos");  ?>
	</li>
	<!--<li> 
	<?php echo $this->Html->link("AVALIAÇÕES", "/Avaliacaos");  ?>
	</li>
	<li>
	<?php echo $this->Html->link("CONTEUDOS", "/Conteudos");  ?>
	</li>
	<li>
	<?php echo $this->Html->link("IDENTIFICAÇÕES", "/Identificacaos");  ?>
	</li>
	<li>
	<?php echo $this->Html->link("INSTRUMENTOS DE AVALIAÇÃO", "/Instrumentos");  ?>
	</li>
	<li>
	<?php echo $this->Html->link("RECURSOS DIDÁTICOS", "/Recursos");  ?>
	</li>
	<li>
	<?php echo $this->Html->link("TÉCNICAS DE ENSINO", "/Tecnicas");  ?>
	</li>
	<li>
	<?php echo $this->Html->link("USUÁRIOS", "/Usuarios");  ?>
	</li> -->			
	</ul>
</nav>
</div> <br><br><br>
